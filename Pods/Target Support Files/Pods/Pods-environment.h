...
// Kamcord
#define COCOAPODS_POD_AVAILABLE_Kamcord
#define COCOAPODS_VERSION_MAJOR_Kamcord 1
#define COCOAPODS_VERSION_MINOR_Kamcord 8
#define COCOAPODS_VERSION_PATCH_Kamcord 8
