...
- (void) setContentOffset:(CGPoint)contentOffset {
  if (self.repeatSize.width > 0) {
    contentOffset.x = fmodf(contentOffset.x, self.repeatSize.width)+self.repeatSize.width;
  }
  if (self.repeatSize.height > 0) {
    contentOffset.y = fmodf(contentOffset.y, self.repeatSize.height)+self.repeatSize.height;
  }
