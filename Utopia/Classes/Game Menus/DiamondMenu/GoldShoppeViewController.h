...
@property (nonatomic, retain) IBOutlet UILabel *textPriceLabel;
...
@interface GoldShoppeViewController : GenViewController <UITableViewDelegate, UITableViewDataSource> {
