...
@property int32_t armorLvl;
@property int32_t amuletId;
@property int32_t amuletLvl;
@property int32_t expGained;
@property int32_t silverGained;
...
- (void) setHasWeaponId:(BOOL) value {
  hasWeaponId_ = !!value;
}
@synthesize weaponId;
- (BOOL) hasWeaponLvl {
  return !!hasWeaponLvl_;
}
- (void) setHasWeaponLvl:(BOOL) value {
  hasWeaponLvl_ = !!value;
}
@synthesize weaponLvl;
- (BOOL) hasArmorId {
  return !!hasArmorId_;
}
- (void) setHasArmorId:(BOOL) value {
  hasArmorId_ = !!value;
}
@synthesize armorId;
- (BOOL) hasArmorLvl {
...
- (void) setHasArmorLvl:(BOOL) value {
  hasArmorLvl_ = !!value;
}
@synthesize armorLvl;
- (BOOL) hasAmuletId {
...
- (void) setHasAmuletId:(BOOL) value {
  hasAmuletId_ = !!value;
}
@synthesize amuletId;
- (BOOL) hasAmuletLvl {
  return !!hasAmuletLvl_;
}
- (void) setHasAmuletLvl:(BOOL) value {
  hasAmuletLvl_ = !!value;
}
@synthesize amuletLvl;
- (BOOL) hasExpGained {
...
- (BOOL) hasSilverGained {
  return !!hasSilverGained_;
}
- (void) setHasSilverGained:(BOOL) value {
  hasSilverGained_ = !!value;
}
@synthesize silverGained;
- (BOOL) hasEquipId {
  return !!hasEquipId_;
}
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasMaxHp) {
    [output writeInt32:3 value:self.maxHp];
  }
  ...
  if (self.hasWeaponLvl) {
    [output writeInt32:7 value:self.weaponLvl];
  }
  if (self.hasArmorId) {
    [output writeInt32:8 value:self.armorId];
  }
  if (self.hasArmorLvl) {
    [output writeInt32:9 value:self.armorLvl];
  }
  if (self.hasAmuletId) {
    [output writeInt32:10 value:self.amuletId];
  }
  if (self.hasAmuletLvl) {
    [output writeInt32:11 value:self.amuletLvl];
  }
  if (self.hasExpGained) {
    [output writeInt32:12 value:self.expGained];
  }
  if (self.hasSilverGained) {
    [output writeInt32:13 value:self.silverGained];
  }
  if (self.hasEquipId) {
    [output writeInt32:14 value:self.equipId];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (int32_t) serializedSize {
  ...
  if (self.hasMaxHp) {
    size += computeInt32Size(3, self.maxHp);
  }
  if (self.hasImageName) {
  ...
  if (self.hasWeaponLvl) {
    size += computeInt32Size(7, self.weaponLvl);
  }
  if (self.hasArmorId) {
    size += computeInt32Size(8, self.armorId);
  }
  if (self.hasArmorLvl) {
    size += computeInt32Size(9, self.armorLvl);
  }
  if (self.hasAmuletId) {
    size += computeInt32Size(10, self.amuletId);
  }
  if (self.hasAmuletLvl) {
    size += computeInt32Size(11, self.amuletLvl);
  }
  if (self.hasExpGained) {
    size += computeInt32Size(12, self.expGained);
  }
  if (self.hasSilverGained) {
    size += computeInt32Size(13, self.silverGained);
  }
  if (self.hasEquipId) {
    size += computeInt32Size(14, self.equipId);
  }
  size += self.unknownFields.serializedSize;
  memoizedSerializedSize = size;
  return size;
...
- (MonsterProto_Builder*) mergeFrom:(MonsterProto*) other {
  ...
  if (other.hasWeaponLvl) {
    [self setWeaponLvl:other.weaponLvl];
  }
  if (other.hasArmorId) {
    [self setArmorId:other.armorId];
  }
  if (other.hasArmorLvl) {
    [self setArmorLvl:other.armorLvl];
  }
  if (other.hasAmuletId) {
    [self setAmuletId:other.amuletId];
  }
  if (other.hasAmuletLvl) {
    [self setAmuletLvl:other.amuletLvl];
  }
  if (other.hasExpGained) {
    [self setExpGained:other.expGained];
  }
  if (other.hasSilverGained) {
    [self setSilverGained:other.silverGained];
  }
  if (other.hasEquipId) {
...
- (MonsterProto_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 48: {
        [self setWeaponId:[input readInt32]];
        break;
      }
      case 56: {
        [self setWeaponLvl:[input readInt32]];
        break;
      }
      case 64: {
        [self setArmorId:[input readInt32]];
        break;
      }
      case 72: {
        [self setArmorLvl:[input readInt32]];
        break;
      }
      case 80: {
        [self setAmuletId:[input readInt32]];
        break;
      }
      case 88: {
        [self setAmuletLvl:[input readInt32]];
        break;
      }
      case 96: {
      ...
      case 104: {
        [self setSilverGained:[input readInt32]];
        break;
      }
      case 112: {
...
- (BOOL) hasWeaponId {
  return result.hasWeaponId;
}
- (int32_t) weaponId {
  return result.weaponId;
}
- (MonsterProto_Builder*) setWeaponId:(int32_t) value {
  result.hasWeaponId = YES;
  result.weaponId = value;
  return self;
}
- (MonsterProto_Builder*) clearWeaponId {
  result.hasWeaponId = NO;
  result.weaponId = 0;
  return self;
}
- (BOOL) hasWeaponLvl {
  return result.hasWeaponLvl;
}
- (int32_t) weaponLvl {
  return result.weaponLvl;
}
- (MonsterProto_Builder*) setWeaponLvl:(int32_t) value {
  result.hasWeaponLvl = YES;
  result.weaponLvl = value;
  return self;
}
- (MonsterProto_Builder*) clearWeaponLvl {
  result.hasWeaponLvl = NO;
  result.weaponLvl = 0;
  return self;
}
- (BOOL) hasArmorId {
  return result.hasArmorId;
}
- (int32_t) armorId {
  return result.armorId;
}
- (MonsterProto_Builder*) setArmorId:(int32_t) value {
  result.hasArmorId = YES;
  result.armorId = value;
  return self;
}
- (MonsterProto_Builder*) clearArmorId {
  result.hasArmorId = NO;
  result.armorId = 0;
  return self;
}
- (BOOL) hasArmorLvl {
  return result.hasArmorLvl;
}
- (int32_t) armorLvl {
  return result.armorLvl;
}
- (MonsterProto_Builder*) setArmorLvl:(int32_t) value {
  result.hasArmorLvl = YES;
  result.armorLvl = value;
  return self;
}
- (MonsterProto_Builder*) clearArmorLvl {
  result.hasArmorLvl = NO;
  result.armorLvl = 0;
  return self;
}
- (BOOL) hasAmuletId {
  return result.hasAmuletId;
}
- (int32_t) amuletId {
  return result.amuletId;
}
- (MonsterProto_Builder*) setAmuletId:(int32_t) value {
  result.hasAmuletId = YES;
  result.amuletId = value;
  return self;
}
- (MonsterProto_Builder*) clearAmuletId {
  result.hasAmuletId = NO;
  result.amuletId = 0;
  return self;
}
- (BOOL) hasAmuletLvl {
  return result.hasAmuletLvl;
}
- (int32_t) amuletLvl {
  return result.amuletLvl;
}
- (MonsterProto_Builder*) setAmuletLvl:(int32_t) value {
  result.hasAmuletLvl = YES;
  result.amuletLvl = value;
  return self;
}
- (MonsterProto_Builder*) clearAmuletLvl {
  result.hasAmuletLvl = NO;
  result.amuletLvl = 0;
  return self;
}
- (BOOL) hasExpGained {
...
- (MonsterProto_Builder*) setExpGained:(int32_t) value {
  result.hasExpGained = YES;
  result.expGained = value;
  return self;
}
- (MonsterProto_Builder*) clearExpGained {
  result.hasExpGained = NO;
  result.expGained = 0;
  return self;
}
- (BOOL) hasSilverGained {
  return result.hasSilverGained;
}
- (int32_t) silverGained {
  return result.silverGained;
}
- (MonsterProto_Builder*) setSilverGained:(int32_t) value {
  result.hasSilverGained = YES;
  result.silverGained = value;
  return self;
}
- (MonsterProto_Builder*) clearSilverGained {
  result.hasSilverGained = NO;
  result.silverGained = 0;
  return self;
}
- (BOOL) hasEquipId {
...
- (MonsterProto_Builder*) setEquipId:(int32_t) value {
  result.hasEquipId = YES;
  result.equipId = value;
  return self;
}
- (MonsterProto_Builder*) clearEquipId {
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasShieldEndTime) {
    [output writeInt64:66 value:self.shieldEndTime];
  }
  if (self.hasElo) {
    [output writeInt32:67 value:self.elo];
  }
  if (self.hasRank) {
...
- (int32_t) serializedSize {
  ...
  if (self.hasShieldEndTime) {
    size += computeInt64Size(66, self.shieldEndTime);
  }
  if (self.hasElo) {
    size += computeInt32Size(67, self.elo);
  }
  if (self.hasRank) {
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  if (self.hasUserEquipId) {
    [output writeInt64:1 value:self.userEquipId];
  }
  if (self.hasUserId) {
    [output writeInt32:2 value:self.userId];
  }
...
- (int32_t) serializedSize {
  ...
  size = 0;
  if (self.hasUserEquipId) {
    size += computeInt64Size(1, self.userEquipId);
  }
  if (self.hasUserId) {
    size += computeInt32Size(2, self.userId);
  }
...
- (FullUserEquipProto_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 8: {
        [self setUserEquipId:[input readInt64]];
        break;
      }
      case 16: {
        [self setUserId:[input readInt32]];
...
- (FullUserEquipProto_Builder*) setUserEquipId:(int64_t) value {
