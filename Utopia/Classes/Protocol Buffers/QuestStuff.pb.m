...
@property QuestProto_QuestType questType;
...
@synthesize mutableQuestIdsRequiredForThisList;
...
- (void) dealloc {
  ...
  self.mutableQuestIdsRequiredForThisList = nil;
...
- (id) init {
  if ((self = [super init])) {
    ...
    self.questType = QuestProto_QuestTypeKillMonster;
    self.jobDescription = @"";
    self.staticDataId = 0;
    self.quantity = 0;
    self.cashReward = 0;
...
static QuestProto* defaultQuestProtoInstance = nil;
+ (void) initialize {
  if (self == [QuestProto class]) {
    defaultQuestProtoInstance = [[QuestProto alloc] init];
  }
}
+ (QuestProto*) defaultInstance {
  return defaultQuestProtoInstance;
}
- (QuestProto*) defaultInstance {
  return defaultQuestProtoInstance;
}
- (NSArray*) questIdsRequiredForThisList {
  return mutableQuestIdsRequiredForThisList;
}
- (int32_t) questIdsRequiredForThisAtIndex:(int32_t) index {
  id value = [mutableQuestIdsRequiredForThisList objectAtIndex:index];
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  for (NSNumber* value in self.mutableQuestIdsRequiredForThisList) {
...
- (int32_t) serializedSize {
  ...
  }
  {
    ...
    size += dataSize;
    size += 2 * self.mutableQuestIdsRequiredForThisList.count;
  }
  if (self.hasQuestGiverImageSuffix) {
...
+ (QuestProto*) parseFromData:(NSData*) data {
  return (QuestProto*)[[[QuestProto builder] mergeFromData:data] build];
}
+ (QuestProto*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (QuestProto*)[[[QuestProto builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (QuestProto*) parseFromInputStream:(NSInputStream*) input {
  return (QuestProto*)[[[QuestProto builder] mergeFromInputStream:input] build];
}
+ (QuestProto*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (QuestProto*)[[[QuestProto builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (QuestProto*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (QuestProto*)[[[QuestProto builder] mergeFromCodedInputStream:input] build];
}
+ (QuestProto*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (QuestProto*)[[[QuestProto builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (QuestProto_Builder*) builder {
  return [[[QuestProto_Builder alloc] init] autorelease];
}
+ (QuestProto_Builder*) builderWithPrototype:(QuestProto*) prototype {
  return [[QuestProto builder] mergeFrom:prototype];
}
- (QuestProto_Builder*) builder {
  return [QuestProto builder];
}
@end

BOOL QuestProto_QuestTypeIsValidValue(QuestProto_QuestType value) {
  switch (value) {
    case QuestProto_QuestTypeKillMonster:
    case QuestProto_QuestTypeDonateMonster:
    case QuestProto_QuestTypeCompleteTask:
    case QuestProto_QuestTypeCollectCoinsFromHome:
    case QuestProto_QuestTypeBuildStruct:
    case QuestProto_QuestTypeUpgradeStruct:
      return YES;
    default:
      return NO;
  }
}
@interface QuestProto_Builder()
@property (retain) QuestProto* result;
@end

@implementation QuestProto_Builder
@synthesize result;
- (void) dealloc {
  self.result = nil;
  [super dealloc];
...
- (id) init {
  if ((self = [super init])) {
    self.result = [[[QuestProto alloc] init] autorelease];
  }
  return self;
}
...
- (QuestProto_Builder*) clone {
  return [QuestProto builderWithPrototype:result];
}
- (QuestProto*) defaultInstance {
  return [QuestProto defaultInstance];
}
- (QuestProto*) build {
...
- (QuestProto*) buildPartial {
  QuestProto* returnMe = [[result retain] autorelease];
  self.result = nil;
  return returnMe;
}
- (QuestProto_Builder*) mergeFrom:(QuestProto*) other {
  if (other == [QuestProto defaultInstance]) {
    return self;
  }
  if (other.hasQuestId) {
  ...
  if (other.mutableQuestIdsRequiredForThisList.count > 0) {
    if (result.mutableQuestIdsRequiredForThisList == nil) {
      result.mutableQuestIdsRequiredForThisList = [NSMutableArray array];
    }
    [result.mutableQuestIdsRequiredForThisList addObjectsFromArray:other.mutableQuestIdsRequiredForThisList];
  }
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 56: {
        ...
        if (QuestProto_QuestTypeIsValidValue(value)) {
      ...
      case 128: {
        [self addQuestIdsRequiredForThis:[input readInt32]];
        break;
      }
      case 138: {
...
- (QuestProto_Builder*) clearQuestType {
  ...
  result.questType = QuestProto_QuestTypeKillMonster;
  return self;
}
- (BOOL) hasJobDescription {
...
- (NSArray*) questIdsRequiredForThisList {
  ...
  return result.mutableQuestIdsRequiredForThisList;
}
- (int32_t) questIdsRequiredForThisAtIndex:(int32_t) index {
  return [result questIdsRequiredForThisAtIndex:index];
}
- (QuestProto_Builder*) replaceQuestIdsRequiredForThisAtIndex:(int32_t) index with:(int32_t) value {
  [result.mutableQuestIdsRequiredForThisList replaceObjectAtIndex:index withObject:[NSNumber numberWithInt:value]];
  return self;
}
- (QuestProto_Builder*) addQuestIdsRequiredForThis:(int32_t) value {
  ...
  [result.mutableQuestIdsRequiredForThisList addObject:[NSNumber numberWithInt:value]];
  return self;
}
- (QuestProto_Builder*) addAllQuestIdsRequiredForThis:(NSArray*) values {
  ...
  [result.mutableQuestIdsRequiredForThisList addObjectsFromArray:values];
  return self;
}
- (QuestProto_Builder*) clearQuestIdsRequiredForThisList {
  result.mutableQuestIdsRequiredForThisList = nil;
  return self;
}
- (BOOL) hasQuestGiverImageSuffix {
