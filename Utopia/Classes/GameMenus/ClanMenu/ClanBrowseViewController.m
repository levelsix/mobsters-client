...
- (void) loadForClan:(FullClanProtoWithClanSize *)c {
  ...
  if (c.clan.requestToJoinRequired) {
    ...
    [self.redButton setImage:[Globals imageNamed:@"pinkmediumbutton.png"] forState:UIControlStateNormal];
  } else {
    ...
    [self.redButton setImage:[Globals imageNamed:@"greenmediumbutton.png"] forState:UIControlStateNormal];
  }
