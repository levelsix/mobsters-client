...
typedef NS_ENUM(SInt32, MiniEventGoalProto_MiniEventGoalType) {
  ...
  MiniEventGoalProto_MiniEventGoalTypeGainBuildingStrength = 7,
  MiniEventGoalProto_MiniEventGoalTypeGainResearchStrength = 8,
  MiniEventGoalProto_MiniEventGoalTypeSpinBasicGrab = 9,
  MiniEventGoalProto_MiniEventGoalTypeSpinUltimateGrab = 10,
  MiniEventGoalProto_MiniEventGoalTypeEnhanceCommon = 11,
  MiniEventGoalProto_MiniEventGoalTypeEnhanceRare = 12,
  MiniEventGoalProto_MiniEventGoalTypeEnhanceSuper = 13,
  MiniEventGoalProto_MiniEventGoalTypeEnhanceUltra = 14,
  MiniEventGoalProto_MiniEventGoalTypeEnhanceEpic = 15,
  MiniEventGoalProto_MiniEventGoalTypeClanHelp = 16,
  MiniEventGoalProto_MiniEventGoalTypeClanDonate = 17,
  MiniEventGoalProto_MiniEventGoalTypeBattleAvenge = 18,
  MiniEventGoalProto_MiniEventGoalTypeBattleRevenge = 19,
  MiniEventGoalProto_MiniEventGoalTypeStealCash = 20,
  MiniEventGoalProto_MiniEventGoalTypeStealOil = 21,
  MiniEventGoalProto_MiniEventGoalTypePvpCatchCommon = 22,
  MiniEventGoalProto_MiniEventGoalTypePvpCatchRare = 23,
  MiniEventGoalProto_MiniEventGoalTypePvpCatchSuper = 24,
  MiniEventGoalProto_MiniEventGoalTypePvpCatchUltra = 25,
  MiniEventGoalProto_MiniEventGoalTypePvpCatchEpic = 26,
};
