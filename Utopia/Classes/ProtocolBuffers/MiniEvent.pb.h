...
typedef NS_ENUM(SInt32, MiniEventGoalProto_MiniEventGoalType) {
  ...
  MiniEventGoalProto_MiniEventGoalTypeBattleAvenge = 13,
  MiniEventGoalProto_MiniEventGoalTypeBattleRevenge = 14,
  MiniEventGoalProto_MiniEventGoalTypeStealCash = 15,
  MiniEventGoalProto_MiniEventGoalTypeStealOil = 16,
  MiniEventGoalProto_MiniEventGoalTypePvpCatchCommon = 17,
  MiniEventGoalProto_MiniEventGoalTypePvpCatchRare = 18,
  MiniEventGoalProto_MiniEventGoalTypePvpCatchSuper = 19,
  MiniEventGoalProto_MiniEventGoalTypePvpCatchUltra = 20,
  MiniEventGoalProto_MiniEventGoalTypePvpCatchEpic = 21,
};
