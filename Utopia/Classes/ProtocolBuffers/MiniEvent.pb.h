...
typedef NS_ENUM(SInt32, MiniEventGoalProto_MiniEventGoalType) {
  ...
  MiniEventGoalProto_MiniEventGoalTypePvpWinAgainstSilver = 29,
  MiniEventGoalProto_MiniEventGoalTypePvpWinAgainstGold = 30,
  MiniEventGoalProto_MiniEventGoalTypePvpWinAgainstPlatinum = 31,
  MiniEventGoalProto_MiniEventGoalTypePvpWinAgainstDiamond = 32,
  MiniEventGoalProto_MiniEventGoalTypeCompleteCommonJob = 33,
  MiniEventGoalProto_MiniEventGoalTypeCompleteRareJob = 34,
  MiniEventGoalProto_MiniEventGoalTypeCompleteSuperJob = 35,
  MiniEventGoalProto_MiniEventGoalTypeCompleteUltraJob = 36,
  MiniEventGoalProto_MiniEventGoalTypeCompleteEpicJob = 37,
  MiniEventGoalProto_MiniEventGoalTypeUseHealthPotionInPvp = 39,
  MiniEventGoalProto_MiniEventGoalTypeUseChillAntidoteInPvp = 40,
  MiniEventGoalProto_MiniEventGoalTypeUsePoisonAntidoteInPvp = 41,
  MiniEventGoalProto_MiniEventGoalTypeUseOrbHammerInPvp = 42,
  MiniEventGoalProto_MiniEventGoalTypeUseHandSwapInPvp = 43,
  MiniEventGoalProto_MiniEventGoalTypeUseBoardShuffleInPvp = 44,
  MiniEventGoalProto_MiniEventGoalTypeUsePuttyInPvp = 45,
};
