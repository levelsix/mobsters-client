...
@property (readonly, strong) NSString* creditsFileName;
...
@property (readonly) int32_t tangoMaxGemReward;
@property (readonly) int32_t tangoMinGemReward;
