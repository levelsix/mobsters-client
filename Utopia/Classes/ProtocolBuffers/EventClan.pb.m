...
@interface CollectClanGiftsRequestProto ()
@property (strong) MinimumUserProto* sender;
@property (strong) NSMutableArray * mutableUserClanGiftList;
@end

@implementation CollectClanGiftsRequestProto
...
@synthesize sender;
@synthesize mutableUserClanGiftList;
@dynamic userClanGiftList;
- (id) init {
  if ((self = [super init])) {
    self.sender = [MinimumUserProto defaultInstance];
  }
...
static CollectClanGiftsRequestProto* defaultCollectClanGiftsRequestProtoInstance = nil;
+ (void) initialize {
  if (self == [CollectClanGiftsRequestProto class]) {
    defaultCollectClanGiftsRequestProtoInstance = [[CollectClanGiftsRequestProto alloc] init];
  }
}
+ (CollectClanGiftsRequestProto*) defaultInstance {
  return defaultCollectClanGiftsRequestProtoInstance;
}
- (CollectClanGiftsRequestProto*) defaultInstance {
  return defaultCollectClanGiftsRequestProtoInstance;
}
- (NSArray *)userClanGiftList {
  return mutableUserClanGiftList;
}
- (UserClanGiftProto*)userClanGiftAtIndex:(NSUInteger)index {
  return [mutableUserClanGiftList objectAtIndex:index];
}
- (BOOL) isInitialized {
  return YES;
}
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  [self.userClanGiftList enumerateObjectsUsingBlock:^(UserClanGiftProto *element, NSUInteger idx, BOOL *stop) {
    [output writeMessage:2 value:element];
  }];
  [self.unknownFields writeToCodedOutputStream:output];
}
...
+ (CollectClanGiftsRequestProto*) parseFromData:(NSData*) data {
  return (CollectClanGiftsRequestProto*)[[[CollectClanGiftsRequestProto builder] mergeFromData:data] build];
}
+ (CollectClanGiftsRequestProto*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (CollectClanGiftsRequestProto*)[[[CollectClanGiftsRequestProto builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (CollectClanGiftsRequestProto*) parseFromInputStream:(NSInputStream*) input {
  return (CollectClanGiftsRequestProto*)[[[CollectClanGiftsRequestProto builder] mergeFromInputStream:input] build];
}
+ (CollectClanGiftsRequestProto*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (CollectClanGiftsRequestProto*)[[[CollectClanGiftsRequestProto builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (CollectClanGiftsRequestProto*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (CollectClanGiftsRequestProto*)[[[CollectClanGiftsRequestProto builder] mergeFromCodedInputStream:input] build];
}
+ (CollectClanGiftsRequestProto*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (CollectClanGiftsRequestProto*)[[[CollectClanGiftsRequestProto builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (CollectClanGiftsRequestProto_Builder*) builder {
  return [[CollectClanGiftsRequestProto_Builder alloc] init];
}
+ (CollectClanGiftsRequestProto_Builder*) builderWithPrototype:(CollectClanGiftsRequestProto*) prototype {
  return [[CollectClanGiftsRequestProto builder] mergeFrom:prototype];
}
- (CollectClanGiftsRequestProto_Builder*) builder {
  return [CollectClanGiftsRequestProto builder];
}
- (CollectClanGiftsRequestProto_Builder*) toBuilder {
  return [CollectClanGiftsRequestProto builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasSender) {
    [output appendFormat:@"%@%@ {\n", indent, @"sender"];
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[CollectClanGiftsRequestProto class]]) {
    return NO;
  }
  CollectClanGiftsRequestProto *otherMessage = other;
  return
      self.hasSender == otherMessage.hasSender &&
      (!self.hasSender || [self.sender isEqual:otherMessage.sender]) &&
      [self.userClanGiftList isEqualToArray:otherMessage.userClanGiftList] &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  __block NSUInteger hashCode = 7;
...
@interface CollectClanGiftsRequestProto_Builder()
@property (strong) CollectClanGiftsRequestProto* result;
@end

@implementation CollectClanGiftsRequestProto_Builder
@synthesize result;
- (id) init {
  if ((self = [super init])) {
    self.result = [[CollectClanGiftsRequestProto alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (CollectClanGiftsRequestProto_Builder*) clone {
  return [CollectClanGiftsRequestProto builderWithPrototype:result];
}
- (CollectClanGiftsRequestProto*) defaultInstance {
  return [CollectClanGiftsRequestProto defaultInstance];
}
...
- (CollectClanGiftsRequestProto*) buildPartial {
  CollectClanGiftsRequestProto* returnMe = result;
  self.result = nil;
  return returnMe;
}
- (CollectClanGiftsRequestProto_Builder*) mergeFrom:(CollectClanGiftsRequestProto*) other {
  if (other == [CollectClanGiftsRequestProto defaultInstance]) {
    return self;
  }
  if (other.hasSender) {
    [self mergeSender:other.sender];
  }
  if (other.mutableUserClanGiftList.count > 0) {
    if (result.mutableUserClanGiftList == nil) {
      result.mutableUserClanGiftList = [[NSMutableArray alloc] initWithArray:other.mutableUserClanGiftList];
    } else {
      [result.mutableUserClanGiftList addObjectsFromArray:other.mutableUserClanGiftList];
    }
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 18: {
        ...
        [input readMessage:subBuilder extensionRegistry:extensionRegistry];
        [self addUserClanGift:[subBuilder buildPartial]];
        break;
      }
    }
  }
...
- (NSMutableArray *)userClanGiftList {
  return result.mutableUserClanGiftList;
}
- (UserClanGiftProto*)userClanGiftAtIndex:(NSUInteger)index {
  return [result userClanGiftAtIndex:index];
}
- (CollectClanGiftsRequestProto_Builder *)addUserClanGift:(UserClanGiftProto*)value {
  if (result.mutableUserClanGiftList == nil) {
    result.mutableUserClanGiftList = [[NSMutableArray alloc]init];
  }
  [result.mutableUserClanGiftList addObject:value];
  return self;
}
- (CollectClanGiftsRequestProto_Builder *)addAllUserClanGift:(NSArray *)array {
  if (result.mutableUserClanGiftList == nil) {
    result.mutableUserClanGiftList = [NSMutableArray array];
  }
  [result.mutableUserClanGiftList addObjectsFromArray:array];
  return self;
}
- (CollectClanGiftsRequestProto_Builder *)clearUserClanGift {
  result.mutableUserClanGiftList = nil;
  return self;
}
@end

@interface CollectClanGiftsResponseProto ()
@property (strong) MinimumUserProto* sender;
@property (strong) UserRewardProto* reward;
@property CollectClanGiftsResponseProto_CollectClanGiftsStatus status;
@end

@implementation CollectClanGiftsResponseProto
...
- (id) init {
  if ((self = [super init])) {
    ...
    self.status = CollectClanGiftsResponseProto_CollectClanGiftsStatusSuccess;
  }
  return self;
}
static CollectClanGiftsResponseProto* defaultCollectClanGiftsResponseProtoInstance = nil;
+ (void) initialize {
  if (self == [CollectClanGiftsResponseProto class]) {
    defaultCollectClanGiftsResponseProtoInstance = [[CollectClanGiftsResponseProto alloc] init];
  }
}
+ (CollectClanGiftsResponseProto*) defaultInstance {
  return defaultCollectClanGiftsResponseProtoInstance;
}
- (CollectClanGiftsResponseProto*) defaultInstance {
  return defaultCollectClanGiftsResponseProtoInstance;
}
...
+ (CollectClanGiftsResponseProto*) parseFromData:(NSData*) data {
  return (CollectClanGiftsResponseProto*)[[[CollectClanGiftsResponseProto builder] mergeFromData:data] build];
}
+ (CollectClanGiftsResponseProto*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (CollectClanGiftsResponseProto*)[[[CollectClanGiftsResponseProto builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (CollectClanGiftsResponseProto*) parseFromInputStream:(NSInputStream*) input {
  return (CollectClanGiftsResponseProto*)[[[CollectClanGiftsResponseProto builder] mergeFromInputStream:input] build];
}
+ (CollectClanGiftsResponseProto*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (CollectClanGiftsResponseProto*)[[[CollectClanGiftsResponseProto builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (CollectClanGiftsResponseProto*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (CollectClanGiftsResponseProto*)[[[CollectClanGiftsResponseProto builder] mergeFromCodedInputStream:input] build];
}
+ (CollectClanGiftsResponseProto*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (CollectClanGiftsResponseProto*)[[[CollectClanGiftsResponseProto builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (CollectClanGiftsResponseProto_Builder*) builder {
  return [[CollectClanGiftsResponseProto_Builder alloc] init];
}
+ (CollectClanGiftsResponseProto_Builder*) builderWithPrototype:(CollectClanGiftsResponseProto*) prototype {
  return [[CollectClanGiftsResponseProto builder] mergeFrom:prototype];
}
- (CollectClanGiftsResponseProto_Builder*) builder {
  return [CollectClanGiftsResponseProto builder];
}
- (CollectClanGiftsResponseProto_Builder*) toBuilder {
  return [CollectClanGiftsResponseProto builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasSender) {
    [output appendFormat:@"%@%@ {\n", indent, @"sender"];
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[CollectClanGiftsResponseProto class]]) {
    return NO;
  }
  CollectClanGiftsResponseProto *otherMessage = other;
  return
      self.hasSender == otherMessage.hasSender &&
      (!self.hasSender || [self.sender isEqual:otherMessage.sender]) &&
...
BOOL CollectClanGiftsResponseProto_CollectClanGiftsStatusIsValidValue(CollectClanGiftsResponseProto_CollectClanGiftsStatus value) {
  switch (value) {
    case CollectClanGiftsResponseProto_CollectClanGiftsStatusSuccess:
    case CollectClanGiftsResponseProto_CollectClanGiftsStatusFailOther:
      return YES;
    default:
      return NO;
  }
}
@interface CollectClanGiftsResponseProto_Builder()
@property (strong) CollectClanGiftsResponseProto* result;
@end

@implementation CollectClanGiftsResponseProto_Builder
@synthesize result;
- (id) init {
  if ((self = [super init])) {
    self.result = [[CollectClanGiftsResponseProto alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (CollectClanGiftsResponseProto_Builder*) clone {
  return [CollectClanGiftsResponseProto builderWithPrototype:result];
}
- (CollectClanGiftsResponseProto*) defaultInstance {
  return [CollectClanGiftsResponseProto defaultInstance];
}
...
- (CollectClanGiftsResponseProto*) buildPartial {
  CollectClanGiftsResponseProto* returnMe = result;
  self.result = nil;
  return returnMe;
}
- (CollectClanGiftsResponseProto_Builder*) mergeFrom:(CollectClanGiftsResponseProto*) other {
  if (other == [CollectClanGiftsResponseProto defaultInstance]) {
    return self;
  }
  if (other.hasSender) {
    [self mergeSender:other.sender];
...
- (CollectClanGiftsResponseProto_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 24: {
        CollectClanGiftsResponseProto_CollectClanGiftsStatus value = (CollectClanGiftsResponseProto_CollectClanGiftsStatus)[input readEnum];
        if (CollectClanGiftsResponseProto_CollectClanGiftsStatusIsValidValue(value)) {
          [self setStatus:value];
        } else {
          [unknownFields mergeVarintField:3 value:value];
        }
...
- (CollectClanGiftsResponseProto_Builder*) clearStatusList {
  result.hasStatus = NO;
  result.status = CollectClanGiftsResponseProto_CollectClanGiftsStatusSuccess;
  return self;
}
@end

@interface DeleteClanGiftsRequestProto ()
@property (strong) MinimumUserProto* sender;
@property (strong) NSMutableArray * mutableExpiredGiftsList;
@end

@implementation DeleteClanGiftsRequestProto
...
static DeleteClanGiftsRequestProto* defaultDeleteClanGiftsRequestProtoInstance = nil;
+ (void) initialize {
  if (self == [DeleteClanGiftsRequestProto class]) {
    defaultDeleteClanGiftsRequestProtoInstance = [[DeleteClanGiftsRequestProto alloc] init];
  }
}
+ (DeleteClanGiftsRequestProto*) defaultInstance {
  return defaultDeleteClanGiftsRequestProtoInstance;
}
- (DeleteClanGiftsRequestProto*) defaultInstance {
  return defaultDeleteClanGiftsRequestProtoInstance;
}
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  [self.expiredGiftsList enumerateObjectsUsingBlock:^(UserClanGiftProto *element, NSUInteger idx, BOOL *stop) {
    [output writeMessage:2 value:element];
  }];
  [self.unknownFields writeToCodedOutputStream:output];
}
...
+ (DeleteClanGiftsRequestProto*) parseFromData:(NSData*) data {
  return (DeleteClanGiftsRequestProto*)[[[DeleteClanGiftsRequestProto builder] mergeFromData:data] build];
}
+ (DeleteClanGiftsRequestProto*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (DeleteClanGiftsRequestProto*)[[[DeleteClanGiftsRequestProto builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (DeleteClanGiftsRequestProto*) parseFromInputStream:(NSInputStream*) input {
  return (DeleteClanGiftsRequestProto*)[[[DeleteClanGiftsRequestProto builder] mergeFromInputStream:input] build];
}
+ (DeleteClanGiftsRequestProto*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (DeleteClanGiftsRequestProto*)[[[DeleteClanGiftsRequestProto builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (DeleteClanGiftsRequestProto*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (DeleteClanGiftsRequestProto*)[[[DeleteClanGiftsRequestProto builder] mergeFromCodedInputStream:input] build];
}
+ (DeleteClanGiftsRequestProto*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (DeleteClanGiftsRequestProto*)[[[DeleteClanGiftsRequestProto builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (DeleteClanGiftsRequestProto_Builder*) builder {
  return [[DeleteClanGiftsRequestProto_Builder alloc] init];
}
+ (DeleteClanGiftsRequestProto_Builder*) builderWithPrototype:(DeleteClanGiftsRequestProto*) prototype {
  return [[DeleteClanGiftsRequestProto builder] mergeFrom:prototype];
}
- (DeleteClanGiftsRequestProto_Builder*) builder {
  return [DeleteClanGiftsRequestProto builder];
}
- (DeleteClanGiftsRequestProto_Builder*) toBuilder {
  return [DeleteClanGiftsRequestProto builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasSender) {
    [output appendFormat:@"%@%@ {\n", indent, @"sender"];
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[DeleteClanGiftsRequestProto class]]) {
    return NO;
  }
  DeleteClanGiftsRequestProto *otherMessage = other;
  return
      self.hasSender == otherMessage.hasSender &&
      (!self.hasSender || [self.sender isEqual:otherMessage.sender]) &&
...
@interface DeleteClanGiftsRequestProto_Builder()
@property (strong) DeleteClanGiftsRequestProto* result;
@end

@implementation DeleteClanGiftsRequestProto_Builder
@synthesize result;
- (id) init {
  if ((self = [super init])) {
    self.result = [[DeleteClanGiftsRequestProto alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (DeleteClanGiftsRequestProto_Builder*) clear {
  self.result = [[DeleteClanGiftsRequestProto alloc] init];
  return self;
}
- (DeleteClanGiftsRequestProto_Builder*) clone {
  return [DeleteClanGiftsRequestProto builderWithPrototype:result];
}
- (DeleteClanGiftsRequestProto*) defaultInstance {
  return [DeleteClanGiftsRequestProto defaultInstance];
}
- (DeleteClanGiftsRequestProto*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (DeleteClanGiftsRequestProto*) buildPartial {
  DeleteClanGiftsRequestProto* returnMe = result;
  self.result = nil;
  return returnMe;
}
- (DeleteClanGiftsRequestProto_Builder*) mergeFrom:(DeleteClanGiftsRequestProto*) other {
  if (other == [DeleteClanGiftsRequestProto defaultInstance]) {
    return self;
  }
  if (other.hasSender) {
    [self mergeSender:other.sender];
...
- (DeleteClanGiftsRequestProto_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (DeleteClanGiftsRequestProto_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSetBuilder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    SInt32 tag = [input readTag];
    switch (tag) {
...
- (DeleteClanGiftsRequestProto_Builder*) setSender:(MinimumUserProto*) value {
  result.hasSender = YES;
  result.sender = value;
  return self;
}
- (DeleteClanGiftsRequestProto_Builder*) setSender_Builder:(MinimumUserProto_Builder*) builderForValue {
  return [self setSender:[builderForValue build]];
}
- (DeleteClanGiftsRequestProto_Builder*) mergeSender:(MinimumUserProto*) value {
  if (result.hasSender &&
      result.sender != [MinimumUserProto defaultInstance]) {
    result.sender =
      [[[MinimumUserProto builderWithPrototype:result.sender] mergeFrom:value] buildPartial];
...
- (DeleteClanGiftsRequestProto_Builder*) clearSender {
  result.hasSender = NO;
  result.sender = [MinimumUserProto defaultInstance];
  return self;
}
...
- (DeleteClanGiftsRequestProto_Builder *)addExpiredGifts:(UserClanGiftProto*)value {
  if (result.mutableExpiredGiftsList == nil) {
...
- (DeleteClanGiftsRequestProto_Builder *)addAllExpiredGifts:(NSArray *)array {
  if (result.mutableExpiredGiftsList == nil) {
...
- (DeleteClanGiftsRequestProto_Builder *)clearExpiredGifts {
  result.mutableExpiredGiftsList = nil;
  return self;
}
@end

@interface DeleteClanGiftsResponseProto ()
@property (strong) MinimumUserProto* sender;
@property DeleteClanGiftsResponseProto_DeleteClanGiftsStatus status;
@end

@implementation DeleteClanGiftsResponseProto
...
- (id) init {
  if ((self = [super init])) {
    self.sender = [MinimumUserProto defaultInstance];
    self.status = DeleteClanGiftsResponseProto_DeleteClanGiftsStatusSuccess;
  }
  return self;
}
static DeleteClanGiftsResponseProto* defaultDeleteClanGiftsResponseProtoInstance = nil;
+ (void) initialize {
  if (self == [DeleteClanGiftsResponseProto class]) {
    defaultDeleteClanGiftsResponseProtoInstance = [[DeleteClanGiftsResponseProto alloc] init];
  }
}
+ (DeleteClanGiftsResponseProto*) defaultInstance {
  return defaultDeleteClanGiftsResponseProtoInstance;
}
- (DeleteClanGiftsResponseProto*) defaultInstance {
  return defaultDeleteClanGiftsResponseProtoInstance;
}
...
+ (DeleteClanGiftsResponseProto*) parseFromData:(NSData*) data {
  return (DeleteClanGiftsResponseProto*)[[[DeleteClanGiftsResponseProto builder] mergeFromData:data] build];
}
+ (DeleteClanGiftsResponseProto*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (DeleteClanGiftsResponseProto*)[[[DeleteClanGiftsResponseProto builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (DeleteClanGiftsResponseProto*) parseFromInputStream:(NSInputStream*) input {
  return (DeleteClanGiftsResponseProto*)[[[DeleteClanGiftsResponseProto builder] mergeFromInputStream:input] build];
}
+ (DeleteClanGiftsResponseProto*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (DeleteClanGiftsResponseProto*)[[[DeleteClanGiftsResponseProto builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (DeleteClanGiftsResponseProto*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (DeleteClanGiftsResponseProto*)[[[DeleteClanGiftsResponseProto builder] mergeFromCodedInputStream:input] build];
}
+ (DeleteClanGiftsResponseProto*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (DeleteClanGiftsResponseProto*)[[[DeleteClanGiftsResponseProto builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (DeleteClanGiftsResponseProto_Builder*) builder {
  return [[DeleteClanGiftsResponseProto_Builder alloc] init];
}
+ (DeleteClanGiftsResponseProto_Builder*) builderWithPrototype:(DeleteClanGiftsResponseProto*) prototype {
  return [[DeleteClanGiftsResponseProto builder] mergeFrom:prototype];
}
- (DeleteClanGiftsResponseProto_Builder*) builder {
  return [DeleteClanGiftsResponseProto builder];
}
- (DeleteClanGiftsResponseProto_Builder*) toBuilder {
  return [DeleteClanGiftsResponseProto builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasSender) {
    [output appendFormat:@"%@%@ {\n", indent, @"sender"];
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[DeleteClanGiftsResponseProto class]]) {
    return NO;
  }
  DeleteClanGiftsResponseProto *otherMessage = other;
  return
      self.hasSender == otherMessage.hasSender &&
      (!self.hasSender || [self.sender isEqual:otherMessage.sender]) &&
      self.hasStatus == otherMessage.hasStatus &&
...
BOOL DeleteClanGiftsResponseProto_DeleteClanGiftsStatusIsValidValue(DeleteClanGiftsResponseProto_DeleteClanGiftsStatus value) {
  switch (value) {
    case DeleteClanGiftsResponseProto_DeleteClanGiftsStatusSuccess:
    case DeleteClanGiftsResponseProto_DeleteClanGiftsStatusFailOther:
      return YES;
    default:
      return NO;
  }
}
@interface DeleteClanGiftsResponseProto_Builder()
@property (strong) DeleteClanGiftsResponseProto* result;
@end

@implementation DeleteClanGiftsResponseProto_Builder
@synthesize result;
- (id) init {
  if ((self = [super init])) {
    self.result = [[DeleteClanGiftsResponseProto alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (DeleteClanGiftsResponseProto_Builder*) clear {
  self.result = [[DeleteClanGiftsResponseProto alloc] init];
  return self;
}
- (DeleteClanGiftsResponseProto_Builder*) clone {
  return [DeleteClanGiftsResponseProto builderWithPrototype:result];
}
- (DeleteClanGiftsResponseProto*) defaultInstance {
  return [DeleteClanGiftsResponseProto defaultInstance];
}
- (DeleteClanGiftsResponseProto*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (DeleteClanGiftsResponseProto*) buildPartial {
  DeleteClanGiftsResponseProto* returnMe = result;
  self.result = nil;
  return returnMe;
}
- (DeleteClanGiftsResponseProto_Builder*) mergeFrom:(DeleteClanGiftsResponseProto*) other {
  if (other == [DeleteClanGiftsResponseProto defaultInstance]) {
    return self;
  }
  if (other.hasSender) {
    [self mergeSender:other.sender];
...
- (DeleteClanGiftsResponseProto_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (DeleteClanGiftsResponseProto_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSetBuilder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    SInt32 tag = [input readTag];
    switch (tag) {
      ...
      case 16: {
        DeleteClanGiftsResponseProto_DeleteClanGiftsStatus value = (DeleteClanGiftsResponseProto_DeleteClanGiftsStatus)[input readEnum];
        if (DeleteClanGiftsResponseProto_DeleteClanGiftsStatusIsValidValue(value)) {
          [self setStatus:value];
        } else {
          [unknownFields mergeVarintField:2 value:value];
        }
...
- (DeleteClanGiftsResponseProto_Builder*) setSender:(MinimumUserProto*) value {
  result.hasSender = YES;
  result.sender = value;
  return self;
}
- (DeleteClanGiftsResponseProto_Builder*) setSender_Builder:(MinimumUserProto_Builder*) builderForValue {
  return [self setSender:[builderForValue build]];
}
- (DeleteClanGiftsResponseProto_Builder*) mergeSender:(MinimumUserProto*) value {
  if (result.hasSender &&
      result.sender != [MinimumUserProto defaultInstance]) {
    result.sender =
      [[[MinimumUserProto builderWithPrototype:result.sender] mergeFrom:value] buildPartial];
...
- (DeleteClanGiftsResponseProto_Builder*) clearSender {
  result.hasSender = NO;
  result.sender = [MinimumUserProto defaultInstance];
  return self;
}
...
- (DeleteClanGiftsResponseProto_Builder*) clearStatusList {
  result.hasStatus = NO;
  result.status = DeleteClanGiftsResponseProto_DeleteClanGiftsStatusSuccess;
  return self;
}
@end
