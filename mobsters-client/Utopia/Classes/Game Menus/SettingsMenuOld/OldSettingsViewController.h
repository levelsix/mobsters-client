...
@interface OldSettingsViewController : GenViewController <SettingSwitchButtonDelegate,MFMailComposeViewControllerDelegate, TabBarDelegate, UITableViewDataSource, UITableViewDelegate>
